# This Makefile is for the Games::PerlWar extension to perl.
#
...
#     AUTHOR => q[Yanick Champoux <yanick@babyl.dyndns.org>]
#     EXE_FILES => [q[pwcreate], q[pwround]]
#     NAME => q[Games::PerlWar]
#     VERSION_FROM => q[PerlWar.pm]
...
# These definitions are from config.sh (via /usr/lib/perl5/5.8.4/i686-linux/Config.pm)
...
EXE_EXT = 
FULL_AR = /usr/bin/ar
VENDORARCHEXP = /usr/lib/perl5/vendor_perl/5.8.4/i686-linux
...
INSTALLVENDORLIB = $(VENDORPREFIX)/lib/perl5/vendor_perl/5.8.4
...
INSTALLVENDORARCH = $(VENDORPREFIX)/lib/perl5/vendor_perl/5.8.4/i686-linux
...
PERL_LIB = /usr/lib/perl5/5.8.4
PERL_ARCHLIB = /usr/lib/perl5/5.8.4/i686-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = $(FIRST_MAKEFILE).old
MAKE_APERL_FILE = $(FIRST_MAKEFILE).aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/lib/perl5/5.8.4/i686-linux/CORE
PERL = /usr/bin/perl5.8.4
FULLPERL = /usr/bin/perl5.8.4
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
MAKEMAKER   = /usr/lib/perl5/5.8.4/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.17
MM_REVISION = 1.133
...
FULLEXT = Games/PerlWar
BASEEXT = PerlWar
PARENT_NAME = Games
DLBASE = $(BASEEXT)
VERSION_FROM = PerlWar.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = PerlWar.pm \
	...
	lib/Games/PerlWar/web/stylesheets/iteration2html.xps \
...
PM_TO_BLIB = lib/Games/PerlWar/web/upload.html \
	...
	lib/Games/PerlWar/web/stylesheets/iteration2html.xps \
	blib/lib/Games/PerlWar/web/stylesheets/iteration2html.xps \
	lib/Games/PerlWar/Rules.pm \
...
$(INST_AUTODIR)/.exists :: /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_AUTODIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h $(INST_AUTODIR)/.exists

	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_AUTODIR)

$(INST_LIBDIR)/.exists :: /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_LIBDIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h $(INST_LIBDIR)/.exists

	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_LIBDIR)

$(INST_ARCHAUTODIR)/.exists :: /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_ARCHAUTODIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h $(INST_ARCHAUTODIR)/.exists
...
$(INST_MAN1DIR)/.exists :: /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_MAN1DIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h $(INST_MAN1DIR)/.exists
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW)\
	  pwround $(INST_MAN1DIR)/pwround.$(MAN1EXT) 
...
$(INST_SCRIPT)/.exists :: /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_SCRIPT)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /usr/lib/perl5/5.8.4/i686-linux/CORE/perl.h $(INST_SCRIPT)/.exists

	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)

EXE_FILES = pwcreate pwround

FIXIN = $(PERLRUN) "-MExtUtils::MY" -e "MY->fixin(shift)"

pure_all :: $(INST_SCRIPT)/pwcreate $(INST_SCRIPT)/pwround
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) $(INST_SCRIPT)/pwcreate $(INST_SCRIPT)/pwround

$(INST_SCRIPT)/pwcreate: pwcreate $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/pwcreate
	$(CP) pwcreate $(INST_SCRIPT)/pwcreate
	$(FIXIN) $(INST_SCRIPT)/pwcreate
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/pwcreate

$(INST_SCRIPT)/pwround: pwround $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/pwround
	$(CP) pwround $(INST_SCRIPT)/pwround
	$(FIXIN) $(INST_SCRIPT)/pwround
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/pwround
